...
const IntroComponent = () => {
  return (
    <section className='justify-center flex relative h-screen py-28' id='home'>
      <div className='flex flex-col-reverse justify-center items-start md:items-center mx-6 md:mx-0 md:flex-row md:space-x-20'>
        ...
        <div data-aos='zoom-in' className='mb-10 md:mb-0'>
          <div className='rounded-full overflow-hidden hover:scale-105 transition-all duration-300'>
            <img
              src={User}
              alt='Profile'
              className='rounded-full w-[160px] h-[160px] md:w-[400px] md:h-[400px] '
            />
          </div>
        </div>
      </div>
